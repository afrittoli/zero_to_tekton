...
\begin{lgrayframerpic}[tekton-triggers.png]{Public domain photo, CC0}%
  {%
  \begin{itemize}
    \item Event Listener
    \item Triggers
...
\begin{2columnsframe}{Advanced \& Security}%
  {%
  Tekton Chains
  \begin{itemize}
  ...
  Custom Task
  \begin{itemize}
    \item Pipeline in Pipelines
    \item Wait Task, GitHub Status
  \end{itemize}
  Custom Interceptors \\
  Trigger Groups \\
  ~\\
  ...
  Workflows
  \begin{itemize}
    \item Quick-start Tekton CI
    \item Configuration in Git
    \item SCM Webhooks \& Notifications
